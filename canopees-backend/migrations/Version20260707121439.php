 ...
 */
final class Version20260707121439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis ADD ouvrier_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE demande_devis ADD CONSTRAINT FK_7DF9460219EB6921 FOREIGN KEY (client_id) REFERENCES client (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE demande_devis ADD CONSTRAINT FK_7DF946024E853A9E FOREIGN KEY (ouvrier_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_7DF946024E853A9E ON demande_devis (ouvrier_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7DF946024E853A9E ON demande_devis');
        $this->addSql('ALTER TABLE demande_devis DROP ouvrier_id');
