 ...
 */
final class Version20260706082000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image_prestation (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, prestation_id INT NOT NULL, INDEX IDX_3D16989B9E45C554 (prestation_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE image_prestation');
