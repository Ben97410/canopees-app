 ...
 */
final class Version20260703090449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery_image_modale CHANGE tarif_id tarif_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery_image_modale CHANGE tarif_id tarif_id INT NOT NULL');
