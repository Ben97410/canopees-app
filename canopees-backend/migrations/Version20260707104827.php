 ...
 */
final class Version20260707104827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis ADD ouvrier VARCHAR(255) DEFAULT NULL, DROP ouvrier_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis ADD ouvrier_id INT DEFAULT NULL, DROP ouvrier');
