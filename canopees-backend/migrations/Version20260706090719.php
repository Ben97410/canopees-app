 ...
 */
final class Version20260706090719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_prestation ADD legende VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_prestation DROP legende, CHANGE image image VARCHAR(255) NOT NULL');
