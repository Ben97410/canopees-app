 ...
 */
final class Version20260703084946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarif DROP galerie, CHANGE image image VARCHAR(255) NOT NULL, CHANGE prix prix VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarif ADD galerie JSON DEFAULT NULL, CHANGE prix prix VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
}
