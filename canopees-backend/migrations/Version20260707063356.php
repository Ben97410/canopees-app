 ...
 */
final class Version20260707063356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis ADD budget VARCHAR(255) DEFAULT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD debut_travaux DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis DROP budget, DROP adresse, DROP debut_travaux');
