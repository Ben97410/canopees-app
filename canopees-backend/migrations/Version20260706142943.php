 ...
 */
final class Version20260706142943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis CHANGE prestation_id prestation_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_devis CHANGE prestation_id prestation_id INT DEFAULT NULL');
